<xsl:stylesheet exclude-result-prefixes='#default' version='1.0' xmlns:fo='http://www.w3.org/1999/XSL/Format' xmlns:xsl='http://www.w3.org/1999/XSL/Transform'>
  ...
  <xsl:param name='eclipse.plugin.id'>org.dbdoclet.tidbit.common</xsl:param>
  <xsl:param name='eclipse.plugin.name'>org.dbdoclet.tidbit.common</xsl:param>
  <xsl:param name='eclipse.plugin.provider'>Michael Fuchs</xsl:param>
  <xsl:param name='eclipse.plugin.version'>6.0.1</xsl:param>
