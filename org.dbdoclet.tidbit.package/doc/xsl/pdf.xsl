<xsl:stylesheet exclude-result-prefixes="#default" version="1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:param name="preferred.mediaobject.role">print</xsl:param>
  ...
  <xsl:attribute-set name="component.title.properties">
    ...
    <xsl:attribute name="color">#221aae</xsl:attribute>
    <xsl:attribute name="background-color">#ffffff</xsl:attribute>
  </xsl:attribute-set>
  <xsl:attribute-set name="revhistory.table.cell.properties">
    <xsl:attribute name="border-top-style">solid</xsl:attribute>
    <xsl:attribute name="border-top-width">0.50pt</xsl:attribute>
    <xsl:attribute name="border-top-color">#000000</xsl:attribute>
    <xsl:attribute name="border-bottom-style">solid</xsl:attribute>
    <xsl:attribute name="border-bottom-width">0.50pt</xsl:attribute>
    <xsl:attribute name="border-bottom-color">#000000</xsl:attribute>
    <xsl:attribute name="border-right-style">solid</xsl:attribute>
    <xsl:attribute name="border-right-width">0.50pt</xsl:attribute>
    <xsl:attribute name="border-right-color">#000000</xsl:attribute>
    <xsl:attribute name="border-left-style">solid</xsl:attribute>
    <xsl:attribute name="border-left-width">0.50pt</xsl:attribute>
  ...
  <xsl:attribute-set name="revhistory.title.properties">
    ...
    <xsl:attribute name="color">#222aaa</xsl:attribute>
    <xsl:attribute name="background-color">#ffffff</xsl:attribute>
  </xsl:attribute-set>
  <xsl:attribute-set name="revhistory.table.properties">
    <xsl:attribute name="space-before.minimum">12.00pt</xsl:attribute>
    <xsl:attribute name="space-before.optimum">12.00pt</xsl:attribute>
    <xsl:attribute name="space-before.maximum">12.00pt</xsl:attribute>
    <xsl:attribute name="space-after.minimum">12.00pt</xsl:attribute>
    <xsl:attribute name="space-after.optimum">12.00pt</xsl:attribute>
    <xsl:attribute name="space-after.maximum">12.00pt</xsl:attribute>
    <xsl:attribute name="padding">6.00pt</xsl:attribute>
    <xsl:attribute name="font-family">DejaVu Sans</xsl:attribute>
    <xsl:attribute name="font-weight">normal</xsl:attribute>
    <xsl:attribute name="font-style">normal</xsl:attribute>
    <xsl:attribute name="font-size">12pt</xsl:attribute>
