 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: StrikeTests.java,v 1.1.1.1 2004/12/21 14:00:09 mfuchs Exp $
...
public class StrikeTests extends ParserTestCase {
    ...
    public StrikeTests(String name) {
        super(name);
    }
    ...
    public void testParseStrike1() throws Exception {
