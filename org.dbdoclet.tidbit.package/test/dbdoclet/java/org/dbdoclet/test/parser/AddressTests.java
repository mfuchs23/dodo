 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: AddressTests.java,v 1.1.1.1 2004/12/21 14:00:11 mfuchs Exp $
...
public class AddressTests extends ParserTestCase {
    ...
    public AddressTests(String name) {
        super(name);
    }
    ...
    public void testParseAddress1() throws Exception {
        ...
        String code = "<address>Address</address>";
        checkHtml(code, 54);
    }

    public void testParseAddress2() throws Exception {

        String code = "<p><address>Address <p>Nested paragraph</p></address></p>";
        checkHtml(code, 83);
    }

    public void testParseAddress3() throws Exception {

        String code = "<p>This is an address tag example: <address>UNICO <p>Invalid Paragraph</p></address>.</p>";
        checkHtml(code, 115);
    }

    public void testParseAddress4() throws Exception {

        String code = "<p><address>Address <i>Italic Comment</i></address></p>";
        checkHtml(code, 88);
    }
