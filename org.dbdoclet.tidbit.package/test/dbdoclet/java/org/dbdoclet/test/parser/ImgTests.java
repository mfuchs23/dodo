 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: ImgTests.java,v 1.1.1.1 2004/12/21 14:00:06 mfuchs Exp $
...
public class ImgTests extends ParserTestCase {
    ...
    public void testParseImg1() throws Exception {
    ...
    public void testParseImg2() throws Exception {

        String code = "<p>Some Text before the img! " +
            "<img src=\"figures/logo.jpg\">" +
            " !Some Text after the image</p>\n";
        checkHtml(code, 105);
    }

    public void testParseImg3() throws Exception {
