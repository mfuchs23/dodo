 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: ATests.java,v 1.1.1.1 2004/12/21 14:00:09 mfuchs Exp $
...
public class ATests extends ParserTestCase {
    ...
    public void testParseA1() throws Exception {

        String code = "<p><a href=\"http://venus:8888/app/do?sessionid=12345&umlaut=�\">Anchor</a></p>";
        checkHtml(code, 86);
    }

    public void testParseA2() throws Exception {
