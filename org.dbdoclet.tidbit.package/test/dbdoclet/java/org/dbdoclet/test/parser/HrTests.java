 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: HrTests.java,v 1.1.1.1 2004/12/21 14:00:07 mfuchs Exp $
...
public class HrTests extends ParserTestCase {
     ...
     */
    private static Log logger = LogFactory.getLog(HrTests.class);

    public static Test suite() {

        return new TestSuite(HrTests.class);
    }

    public void testParseHr1() throws Exception {
