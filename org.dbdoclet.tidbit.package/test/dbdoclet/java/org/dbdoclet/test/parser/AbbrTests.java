 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: AbbrTests.java,v 1.1.1.1 2004/12/21 14:00:07 mfuchs Exp $
...
public class AbbrTests extends ParserTestCase {
    ...
    public void testParseAbbr1() throws Exception {

        String code = "<p><abbr>Abbreviation</abbr></p>";
        checkHtml(code, 37);
    }

    public void testParseAbbr2() throws Exception {

        String code = "<p><abbr>Abbreviation <p>Invalid nested paragraph</p></abbr></p>";
        checkHtml(code, 74);
    }

    public void testParseAbbr3() throws Exception {

        String code = "<p><abbr>Abbreviation <i>Italic Comment</i></abbr></p>";
        checkHtml(code, 59);
    }
