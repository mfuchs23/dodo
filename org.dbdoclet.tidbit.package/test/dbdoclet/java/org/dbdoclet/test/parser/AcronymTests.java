 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: AcronymTests.java,v 1.1.1.1 2004/12/21 14:00:10 mfuchs Exp $
...
public class AcronymTests extends ParserTestCase {
    ...
    public AcronymTests(String name) {
        super(name);
    }
    ...
    public void testParseAcronym1() throws Exception {

        String code = "<p><acronym>Acronym</acronym></p>";
        checkHtml(code, 38);
    }

    public void testParseAcronym2() throws Exception {

        String code = "<p><acronym>Acronym <p>Invalid nested paragraph.</p></acronym></p>";
        checkHtml(code, 76);
    }

    public void testParseAcronym3() throws Exception {

        String code = "<p><acronym>Acronym <i>Italic Comment</i></acronym></p>";
        checkHtml(code, 60);
    }
