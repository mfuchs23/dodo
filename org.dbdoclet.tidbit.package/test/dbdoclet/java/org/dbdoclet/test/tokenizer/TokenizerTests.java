 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: TokenizerTests.java,v 1.1.1.1 2004/12/21 14:00:06 mfuchs Exp $
...
public class TokenizerTests extends TestCase {
    ...
    private static Log logger = LogFactory.getLog(TokenizerTests.class);
    ...
    public void testComplex1() throws Exception {
        ...
        String code = "<p> Rock'n'Roll, Surf&Learn<p>";
