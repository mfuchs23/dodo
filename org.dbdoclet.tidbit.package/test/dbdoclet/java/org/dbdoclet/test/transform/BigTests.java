 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: BigTests.java,v 1.1.1.1 2004/12/21 14:00:04 mfuchs Exp $
...
public class BigTests extends XmlTestCase {
     ...
     */
    private static Log logger = LogFactory.getLog(BigTests.class);

    public static Test suite() {

        return new TestSuite(BigTests.class);
    }

    public void testTransformSimpleBig() throws Exception {

        String code = "<p>This is <big>big text</big>. Wow!</p>";
 ...
 *
 * Revision 1.1.1.1  2003/08/01 13:19:14  cvs
 * DocBook Doclet
 *
 ...
 * DocBook Doclet 0.40
 *
 * Revision 1.1.1.1  2003/03/17 20:51:28  cvs
 * dbdoclet
 *
 */
