 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: BrTests.java,v 1.1.1.1 2004/12/21 14:00:03 mfuchs Exp $
...
public class BrTests extends XmlTestCase {
    ...
    public void testTransformSimpleBr() throws Exception {

        String code = "<p>A simple Linebreak.<br>And a text in the next line.</p>.";
        checkDocBook(code, true);
    }

    public void testTransformBr2() throws Exception {
