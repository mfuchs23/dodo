 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: SerialTests.java,v 1.1.1.1 2004/12/21 14:00:03 mfuchs Exp $
...
public class SerialTests extends XmlTestCase {
     ...
     */
    private static Log logger = LogFactory.getLog(SerialTests.class);

    public static Test suite() {

        return new TestSuite(SerialTests.class);
    }

    public void testTransformSerial() throws Exception {

        String code = "@serial serializable field, stores something.";
        checkDocBook(code, true);
    }
}

/*
 * $Log: SerialTests.java,v $
 ...
 *
 * Revision 1.1.1.1  2003/08/01 13:18:38  cvs
 * DocBook Doclet
 *
 ...
 * DocBook Doclet 0.40
 *
 * Revision 1.1.1.1  2003/03/17 20:50:52  cvs
 * dbdoclet
 *
 */
