 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: AddressTests.java,v 1.1.1.1 2004/12/21 14:00:05 mfuchs Exp $
...
public class AddressTests extends XmlTestCase {
     ...
     */
    private static Log logger = LogFactory.getLog(AddressTests.class);

    public static Test suite() {

        return new TestSuite(AddressTests.class);
    }

    public void testTransformAddress() throws Exception {

        String code = "This is an address tag example: <address>UNICO</address>.";
        checkDocBook(code, true);
    }

    public void testTransformAddressP() throws Exception {

        String code = "This is an address tag example: <address>UNICO <p>Invalid Paragraph</p></address>.";
        checkDocBook(code, true);
    }

    public void testTransformAddressI() throws Exception {

        String code = "This is an address tag example: <address>UNICO <i>Media GmbH</i></address>.";
        checkDocBook(code, true);
    }
}

/*
 * $Log: AddressTests.java,v $
