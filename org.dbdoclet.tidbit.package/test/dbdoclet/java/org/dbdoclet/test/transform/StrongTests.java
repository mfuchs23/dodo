 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: StrongTests.java,v 1.1.1.1 2004/12/21 14:00:05 mfuchs Exp $
...
public class StrongTests extends XmlTestCase {
     ...
     */
    private static Log logger = LogFactory.getLog(StrongTests.class);

    public static Test suite() {

        return new TestSuite(StrongTests.class);
    }

    public void testTransformSimpleStrong() throws Exception {

        String code = "This a text with a <strong>strong</strong> word.\n";
        checkDocBook(code, true);
    }

    public void testTransformStrong1() throws Exception {

        String code = "<hr size=\"3\">\n" +
            "This a text with a <strong>strong</strong> word.\n";
        checkDocBook(code, true);
    }
}

/*
 * $Log: StrongTests.java,v $
 ...
 * DocBook Doclet 0.40
 *
 * Revision 1.1.1.1  2003/03/17 20:51:30  cvs
 * dbdoclet
 *
 */
