 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: AcronymTests.java,v 1.1.1.1 2004/12/21 14:00:04 mfuchs Exp $
...
public class AcronymTests extends XmlTestCase {
     ...
     */
    private static Log logger = LogFactory.getLog(AcronymTests.class);

    public static Test suite() {

        return new TestSuite(AcronymTests.class);
    }

    public void testTransformAcronym1() throws Exception {

        String code = "This is an acronym tag example: <acronym>UNICO</acronym>.";
        checkDocBook(code, true);
    }

    public void testTransformAcronym2() throws Exception {

        String code = "This is an acronym tag example: <acronym>UNICO <p>Invalid Paragraph</p></acronym>.";
        checkDocBook(code, true);
    }

    public void testTransformAcronym3() throws Exception {

        String code = "This is an acronym tag example: <acronym>UNICO <i>Media GmbH</i></acronym>.";
        checkDocBook(code, true);
    }
}

/*
 * $Log: AcronymTests.java,v $
 ...
 *
 * Revision 1.1.1.1  2003/08/01 13:19:10  cvs
 * DocBook Doclet
 *
 ...
 * DocBook Doclet 0.40
 *
 * Revision 1.1.1.1  2003/03/17 20:51:23  cvs
 * dbdoclet
 *
 */
