 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: StrikeTests.java,v 1.1.1.1 2004/12/21 14:00:04 mfuchs Exp $
...
public class StrikeTests extends XmlTestCase {
     ...
     */
    private static Log logger = LogFactory.getLog(StrikeTests.class);

    public static Test suite() {

        return new TestSuite(StrikeTests.class);
    }

    public void testTransformSimpleStrike() throws Exception {

        String code = "<p><strike>Striked simple paragraph</strike></p>";
        checkDocBook(code, true);
    }
}

/*
 * $Log: StrikeTests.java,v $
 ...
 *
 * Revision 1.1.1.1  2003/08/01 13:18:46  cvs
 * DocBook Doclet
 *
 ...
 * DocBook Doclet 0.40
 *
 * Revision 1.1.1.1  2003/03/17 20:51:00  cvs
 * dbdoclet
 *
 */
