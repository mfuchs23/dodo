 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: TextTests.java,v 1.1.1.1 2004/12/21 14:00:01 mfuchs Exp $
...
public class TextTests extends XmlTestCase {
    ...
    public void testTransformText1() throws Exception {

        String code = "Text ohne Paragraph.";
        checkDocBook(code, true);
    }

    public void testTransformText2() throws Exception {
    ...
    public void testTransformText3() throws Exception {
    ...
    public void testTransformText4() throws Exception {
    ...
    public void testTransformText5() throws Exception {
 ...
 *
 * Revision 1.1.1.1  2003/08/01 13:18:20  cvs
 * DocBook Doclet
 *
