 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: StyleTests.java,v 1.1.1.1 2004/12/21 14:00:04 mfuchs Exp $
...
public class StyleTests extends XmlTestCase {
     ...
     */
    private static Log logger = LogFactory.getLog(StyleTests.class);

    public static Test suite() {

        return new TestSuite(StyleTests.class);
    }

    public void testTransformStyle1() throws Exception {
 ...
 *
 * Revision 1.1.1.1  2003/08/01 13:19:06  cvs
 * DocBook Doclet
 *
 ...
 * dbdoclet
 *
 * Revision 1.1  2003/05/30 10:10:53  mfuchs
 * Release 0.43
 *
 */
