...
InstallDir "$PROGRAMFILES\DocBook Doclet"

;--------------------------------
;Interface Settings

!define MUI_ABORTWARNING
!define MUI_ICON "root\Programme\dbdoclet\icons\48x48\dodo.ico"
!define MUI_UNICON "root\Programme\dbdoclet\icons\48x48\dodo.ico"
...
!insertmacro MUI_PAGE_LICENSE "root\Programme\dbdoclet\LICENSE"
...
Section dbdoclet
  ...
  CreateShortCut '$SMPROGRAMS\DocBook Doclet\dbdoclet.lnk' 'javaw'  '-Dorg.dbdoclet.doclet.home="$INSTDIR" -jar "$INSTDIR\jars\dbdtidbit.jar"' '$INSTDIR\icons\48x48\dodo.ico'
  ...
  CreateShortCut '$DESKTOP\dbdoclet.lnk' 'javaw'  '-Dorg.dbdoclet.doclet.home="$INSTDIR" -jar "$INSTDIR\jars\dbdtidbit.jar"' '$INSTDIR\icons\48x48\dodo.ico'
